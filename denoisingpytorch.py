...
"""
Step 2: Loading and Cropping the images to avoid black edges due to rotation in the augmented data if applicable
"""
...
"""
For best results we will combine two type of horizental noise, one that destroy the pixels and one that distort the image similar to the bad data obsereved in STM measurements. However we can use only one type of noise to train the NN

Stp3: Add First striped Noise
...
Note: the combination of both striped noises make a very realistic striped noise observed in STM images
"""
...
# %%% Modify the noise parameter in here %%%%
...
"""
Step 5: Reshape, this step depends on the pixel size of the images and the autoencoder, larger the images longer it will take to train
in this situation my images were 630X630 pixels
if you want to choose differents size you will have to modify the Network accordingly
"""
...
Final Step: moment of truth  denoising STM images never seen by the model
